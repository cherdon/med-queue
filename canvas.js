...
let ContinuousVisualization = function(height, width, context) {
    this.draw = function (agents) {
        ...
        agents.forEach(agent => {
            ...
            if (agent.shape === "patient")
                this.drawCircle(a.x, a.y, a.radius, a.color, a.filled);
...
let Simple_Continuous_Module = function(canvas_width, canvas_height) {
    ...
    canvas_tag += "style='grid-row: 1 / span 2;border:2px solid'></canvas>";
    ...
    let canvasDraw = new ContinuousVisualization(canvas_height, canvas_width, context);
