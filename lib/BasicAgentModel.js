...
var doctorRow = 3;
var doctorCol = 20;
var receptionistRow = 25;
var receptionistCol = 20;
const triageNurseRow = 21;
const triageNurseCol = 23;
const pharmacistRow = 23;
const pharmacistCol = 10;
const radiologistRow = 21;
const radiologistCol = 31;

// for waiting areas
const triageWaitStartRow = 20;
const triageWaitStartCol = 18;
const treatmentWaitStartRow = 8;
const treatmentWaitStartCol = 18;
const treatmentStartRow = 2;
const treatmentStartCol = 18;
const pharmacyWaitRow = 18;
const pharmacyWaitCol = 7;
const xrayWaitStartRow = 18;
const xrayWaitStartCol = 30;
const xrayStartRow = 20;
const xrayStartCol = 29;

const waitingAreaColor = "#33AAFF"
...
var caregivers = [
	...
	{"type":DOCTOR,"label":"Radiologist","location":{"row":radiologistRow,"col":radiologistCol},"state":IDLE},
	{"type":RECEPTIONIST,"label":"Receptionist","location":{"row":receptionistRow,"col":receptionistCol},"state":IDLE},
	{"type":RECEPTIONIST,"label":"Triage Nurse","location":{"row":triageNurseRow,"col":triageNurseCol},"state":IDLE},
	{"type":RECEPTIONIST,"label":"Pharmacist","location":{"row":pharmacistRow,"col":pharmacistCol},"state":IDLE}
];
...
var areas =[
 ...
 {"label":"Triage Waiting","startRow":triageWaitStartRow,"numRows":2,"startCol":triageWaitStartCol,"numCols":4,"color":waitingAreaColor},
 {"label":"Treatment room","startRow":treatmentStartRow,"numRows":3,"startCol":treatmentStartCol,"numCols":4,"color":"pink"},
 {"label":"Treatment waiting","startRow":treatmentWaitStartRow,"numRows":2,"startCol":treatmentWaitStartCol,"numCols":4,"color":waitingAreaColor},
 {"label":"Pharmacy waiting","startRow":pharmacyWaitRow,"numRows":3,"startCol":pharmacyWaitCol,"numCols":6,"color":waitingAreaColor},
 {"label":"Xray waiting","startRow":xrayWaitStartRow,"numRows":1,"startCol":xrayWaitStartCol,"numCols":2,"color":waitingAreaColor},
 {"label":"Xray","startRow":xrayStartRow,"numRows":2,"startCol":xrayStartCol,"numCols":4,"color":"pink"}
]
var waitingRoom = areas[0]; // the waiting room is the first element of the areas array

var currentTime = 0;
var statistics = [
{"name":"Average time in clinic, Type A: ","location":{"row":1,"col":30},"cumulativeValue":0,"count":0},
{"name":"Average time in clinic, Type B: ","location":{"row":2,"col":30},"cumulativeValue":0,"count":0}
];
...
function redrawWindow(){
	...
	numRows = 30;//Math.ceil(surfaceHeight/cellWidth);
...
function addDynamicAgents(){
	...
	if (Math.random()< probArrival){
		var newpatient = {"id":1,"type":"A","location":{"row":30,"col":20},
