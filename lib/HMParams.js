...
for (i = 1; i <= caregiverParams.traige_nurse.number; i++){
    ...
    visual.caregivers.push(newTraige)
}

var emergencyRoom = visual.areas[6]
var newDoctor = {"type":DOCTOR,"label":"Emergency Doctor", "location":{"row": emergencyRoom.location.row + (emergencyRoom.numRows/2), "col": emergencyRoom.location.col + (emergencyRoom.numCols/2) },"state":IDLE}
